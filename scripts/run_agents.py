...
- The schedule starts from TOMORROW: {day_names[1]} (not Monday, not today — literally {day_names[1]}).
- The 7 days in order are: {', '.join(day_names[1:])} plus one more day after that.
