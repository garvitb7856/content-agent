...
(async () => {
  ...
  run('2.7 Update Hook Bank',     'node scripts/update_hook_bank.js');
  run('2.8 Detect New Posts',     'node scripts/detect_new_posts.js');
  run('2.9 Compute Patterns',     'node scripts/compute_patterns.js');
